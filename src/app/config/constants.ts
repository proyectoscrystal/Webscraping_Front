export class AppSettings {
  ...
  // public static Captcha :string = '6LfSkxAaAAAAAJjbsB9OzDdWDC-5KGdgHjHqsJr_';
  // public static Api: string = 'https://scrapingblackbox.herokuapp.com';
  // public static Model: string = 'https://scrapingblackbox.herokuapp.com/sendImgsModel';
  // public static Filter: string = 'https://scrapingblackbox.herokuapp.com/filtroImagen';
}
